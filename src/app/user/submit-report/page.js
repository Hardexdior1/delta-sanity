...
export default function CreateReport() {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("AGO", reportData.AGO ? `${reportData.AGO} litres` : "0")
    formData.append("PMS", reportData.PMS ? `${reportData.PMS} litres` : "0")
    formData.append("DPK", reportData.DPK ? `${reportData.DPK} litres` : "0")
    ...
    // ✅ Properly send location as JSON string
    ...
    <div className="max-w-4xl mx-auto p-4 text-black">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div>
            <label className="block mb-1 font-medium">Longitudee</label>
            <input
              type="number"
              step="any"
              name="lng"
